...
/*
function replace_filter(f, g) { // Non rispetta la consegna effettiva di non usare le librerie map e filter
    return function(a) {
        let b = a.map(f) // Applica la funzione f su ogni elemento di a
        let c = b.filter(g) // Filtra b usando la funzione g
